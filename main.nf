...
workflow "CALL" {
    ...
    main:
        ...
        txt2 = bam_grouping.out.filter{ it[1] instanceOf nextflow.util.BlankSeparatedList && it[1].size() > 1 }.transpose().map{ tuple(it[0], it[1].baseName.tokenize(".").init().join(""), it[1]) }
